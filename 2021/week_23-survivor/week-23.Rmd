...
#  scale_color_fivethirtyeight() +
  ...
  labs(title = "Survivor TV Show Viewers",
       subtitle = "Million viewers at **season** <b style='color:#ff6347;'>premier</b> vs <b style='color:#0000ff;'>finale</b> from 2000 (bottom) to 2019 (top)",
       caption = "Source: SurvivoR | Visualization: @maxwelco",
       y = NULL,
       x = NULL) +
