...
consumption1 |> 
  ...
  labs(title = "Global seafood consumption",
       subtitle = "Seafood consumption in kg per capita for a country population within a continent in 2017",
  ...
  theme(legend.position = "right",
        legend.background = element_rect(fill = "#F9F6EE"),
        legend.text = element_markdown(size = 20, face = "bold"),
