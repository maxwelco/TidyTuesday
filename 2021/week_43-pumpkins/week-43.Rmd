...
(tomato + giant_wat + long_gou) / (giant_pum + field_pum + giant_sq) +
   plot_annotation(title = "Most frequent participating growers in the <b style='color:#ff7518;'>Great Pumpkin Commonwealth</b><img src='https://gpc1.org/wp-content/uploads/2018/11/GPCMedium512.png' width='25'/>",
                   subtitle = "Number of attemps made by growers to win the contest by <b style='color:4;'>category</b>. A <img src='https://uc-emoji.azureedge.net/orig/2e/0c6ff8789032ae9f484280fd98ac74.png' width='10'/> represents at least a first place from 2013 to 2021.",
...
ggsave("fig_43.png", bg = "#F9F6EE", width = 14, height = 10)
```