...
fig1 +
  ...
  annotate("text", x = 1998, y = 62, 
           label = "The difference between top and bottom median hourly wage by state has increased in the past 20 years",
           hjust = 0, 
           size = 10,
           color = "#333333",
           family = "lato") +
...
```{r}
label1 <- "A nurse in California earned twice more than a nurse in Alabama during the pandemic in 2020"

fig4 +
  annotate("text", x = 2004, y = 10,
           label = label1, 
           size = 10,
           hjust = 0,
           lineheight = 0.3,
