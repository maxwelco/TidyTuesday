...
lemurs %>% 
  ...
  mutate(sex = fct_recode(sex, 
         ...
         age_category = fct_relevel(age_category, 
                                    levels = c("Adult", "Young adult", "Juvenile")),
...
ggplot(data = lemurs2,
  ...
  labs(title = "Where are the lemurs <b style='color:#ff9900;'>hybrids</b>?",
       subtitle = "The <b style='color:#ff9900;'>hybrids</b>, *Eulemur Eulemur* and *Varecia Varecia* are the minority among <b style='color:#1D1D1D;'>non-hybrid</b> lemurs. <br>All hybrids were born in captivity and most of them are located at Duke Lemur Center",
