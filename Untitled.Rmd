...
states_populations <- read_csv("https://raw.githubusercontent.com/AbdoulMa/TidyTuesday/main/2021_w41/states_populations.csv") %>% 
  select(State, Pop)
...
(map <- nurses_2020 %>% 
  ...
  theme(
    ...
    plot.title = element_text(size = rel(3.5),hjust = .5, margin = margin(t = 10, b = 15),  face = "bold"),
